...
assert(x == 1)
f(2)
assert(type(f) == 'function')        -- testing globals ;-)
...
setfenv(0, _G)        -- testing limits for special instructions
...
print'+'
if rawget(_G, "querytab") then        -- testing clearing of dead elements from tables
